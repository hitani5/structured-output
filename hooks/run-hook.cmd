...
REM On Windows: cmd.exe runs the batch portion, which locates bash and calls it.
REM On Unix: the shell treats this as a script (`:` is a no-op) and falls
REM through to the bottom.
REM
...
REM No bash found -- exit silently. The session still starts, just without
REM the format rules injected.
exit /b 0
CMDBLOCK
